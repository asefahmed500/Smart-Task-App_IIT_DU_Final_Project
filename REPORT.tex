...
\onehalfspacing
\raggedbottom
% Images live in the SAME folder as this .tex file (copy them alongside).
\graphicspath{{./}}

% Safe fallback so the document compiles even if an image is missing.
\usepackage{xcolor}
...
\begin{titlepage}
\centering
% \includegraphics[width=3cm]{du-crest} % uncomment once you have the crest image
\vspace{0.5cm}
...
\vspace{0.5cm}
{\Large\bfseries ``SmartTask -- Real-Time Collaborative Kanban Task Management System''\par}
\vspace{2cm}
{\itshape Submitted By\par}
\vspace{0.3cm}
\textbf{Name:} [INSERT YOUR NAME]\\
\textbf{Exam Roll:} [INSERT ROLL]\\
\textbf{ID:} [INSERT ID]\\
\textbf{Batch:} [INSERT BATCH]\\
\textbf{Session:} [INSERT SESSION]\par
\vspace{1cm}
{\itshape A project submitted to the Institute of Information Technology (IIT), DU\\
for the partial fulfillment of the degree of [INSERT DEGREE NAME]\par}
\vspace{2cm}
