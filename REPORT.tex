...
\textbf{Exam Roll:} [INSERT ROLL]\\
\textbf{ID:} [INSERT ID]\\
\textbf{Batch:} 6th \\
\textbf{Session:} [INSERT SESSION]

\vspace{0.35cm}

{\itshape
A project submitted to the Institute of Information Technology (IIT), DU\\
for the partial fulfillment of the degree of [INSERT DEGREE NAME]
\par}
...
\textbf{[INSERT SUPERVISOR NAME]}\\
[INSERT SUPERVISOR DESIGNATION]\\
\textbf{Institute of Information Technology (IIT)}\\
\textbf{University of Dhaka}

\vspace{0.35cm}

\textbf{Date:} [INSERT SUBMISSION DATE]
...
Supervisor, [INSERT SUPERVISOR NAME], [INSERT DESIGNATION], Institute of
...
SmartTask system and the preparation of this report. [Add a sentence or two of
your own.]
...
\vspace{1.5cm}
\noindent Student's Name: [INSERT NAME]\\
...
Exam Roll & : [INSERT ROLL] \\
ID & : [INSERT ID] \\
Batch & : [INSERT BATCH] \\
Program & : [INSERT PROGRAM] \\
Date of Submission & : [INSERT DATE] \\
Supervised By & : [INSERT SUPERVISOR NAME], [INSERT DESIGNATION], \\
