...
\begin{figure}[h]
  ...
  \caption{Team members page with per-member workload statistics (total,
  completed, in-progress, overdue tasks and completion rate) and a task-view
  dialog, letting the manager measure each member's contribution.}
\end{figure}
