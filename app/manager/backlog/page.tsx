...
export default async function ManagerBacklogPage({
  searchParams,
}: {
  ...
  return <BacklogView boardId={boardId} boards={boards} basePath="/manager" currentUser={{ id: session.id, name: session.name, image: session.image }} />
}
